...
function CreateEnrollment(props) {
  ...
  async function createEnrollment() {
    ...
    formData.append(
      "highest_qualification",
      enrollmentValues.highest_qualification
    );
    formData.append("skill_set", enrollmentValues.skill_set);
    formData.append(
      "current_company_name",
      enrollmentValues.current_company_name
    );
    formData.append(
      "current_designation",
      enrollmentValues.current_designation
    );
    formData.append(
      "ictak_course_handling",
      enrollmentValues.ictak_course_handling
    );
            ...
            <form onSubmit={handleSubmit}>
              ...
              <label className="form-group">
                <input
                  ...
                  name="first_name"
                  value={enrollmentValues.first_name}
              ...
              <label className="form-group">
                <input
                  ...
                  className="form-control"
                  name="last_name"
                  value={enrollmentValues.last_name}
                  onChange={handleChange}
                />
                <span> Last name *</span>
              ...
              <label className="form-group">
                <input
                  type="date"
                  className="form-control"
                  value={enrollmentValues.date_of_birth}
                  onChange={handleChange}
                  name="date_of_birth"
                />
              ...
              <label className="form-group">
                <input
                  type="text"
                  className="form-control"
                  value={enrollmentValues.address_line_1}
                  onChange={handleChange}
                  name="address_line_1"
                />
              ...
              <label className="form-group">
                <input
                  type="text"
                  className="form-control"
                  value={enrollmentValues.address_line_2}
                  onChange={handleChange}
                  name="address_line_2"
                />
              ...
              <label className="form-group">
                <input
                  type="text"
                  className="form-control"
                  value={enrollmentValues.district}
                  onChange={handleChange}
                  name="district"
                />
                <span> District</span>
              ...
              <label className="form-group">
                <input
                  type="text"
                  className="form-control"
                  value={enrollmentValues.zip_Code}
                  onChange={handleChange}
                  name="zip_Code"
                />
                <span> ZIP Code</span>
              ...
              <label className="form-group">
                <input
                  ...
                  name="email_address"
                  className="form-control"
                  value={enrollmentValues.email_address}
                  onChange={handleChange}
                />
              ...
              <label className="form-group">
                <input
                  ...
                  name="password"
                  className="form-control"
                  value={enrollmentValues.password}
                  onChange={handleChange}
                />
                <span> Password*</span>
              ...
              <label className="form-group">
                <input
                  ...
                  className="form-control"
                  value={enrollmentValues.confirmpassword}
                  onChange={handleChange}
                />
              ...
              <label className="form-group">
                <input
                  ...
                  className="form-control"
                  value={enrollmentValues.highest_qualification}
                  onChange={handleChange}
                />
              ...
              <label className="form-group">
                <input
                  ...
                  name="skill_set"
                  className="form-control"
                  value={enrollmentValues.skill_set}
                  onChange={handleChange}
                />
                <span> Skill set *</span>
              ...
              <label className="form-group">
                <input
                  ...
                  className="form-control"
                  value={enrollmentValues.current_company_name}
                  onChange={handleChange}
                />
              ...
              <label className="form-group">
                <input
                  ...
                  className="form-control"
                  value={enrollmentValues.current_designation}
                  onChange={handleChange}
                />
              ...
              <label className="form-group">
                <select
                  ...
                  className="form-control course_selection"
                  defaultValue={""}
                  value={enrollmentValues.ictak_course_handling}
                  onChange={handleChange}
                >
                  <option value=""></option>
              ...
              <label className="form-group1">
                ...
                <small>
                  Possible file types: JPG,PNG. Maximum file size: 10 MB.
                </small>
